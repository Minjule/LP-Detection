...
def write_csv(results, output_path):
    ...
    with open(output_path, 'w') as f:
        f.write('{},{},{},{}\n'.format('license_plate_bbox', 'license_plate_bbox_score', 'license_number', 'license_number_score'))

        f.write('{},{},{},{}\n'.format('[{} {} {} {}]'.format(results['license_plate']['bbox'][0],
...
def read_license_plate(license_plate_crop):
    ...
    plates = reader.readtext(license_plate_crop)
    number = True
    returntext = ""
    for plate in plates:
        bbox, text, score = plate            
